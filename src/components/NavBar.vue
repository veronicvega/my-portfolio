<template>
  ...
  >
    ...
    <nav
      :class="[
        'fixed inset-0 z-20 flex flex-col items-center bg-black md:relative md:bg-transparent md:flex md:justify-between md:flex-row',
...
const scrollToSection = (href) => {
  ...
  if (section) {
    section.scrollIntoView({ behavitor: "smooth" });
  }
};
</script>